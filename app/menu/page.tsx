...
// 1. Next.js build vaqtida xato bermasligi uchun sahifani majburiy dinamik qilamiz
export const dynamic = "force-dynamic";

function MenuContent() {
  const searchParams = useSearchParams();

  // searchParams null bo'lishi ehtimolini tekshiramiz (build vaqti uchun muhim)
        ...
        fallback={
          <div className="flex min-h-screen items-center justify-center bg-background">
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">Menyu yuklanmoqda...</p>
            </div>
          </div>
        }
      >
